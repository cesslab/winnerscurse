...
from .pages import (
    QuizPartOne, QuizPartTwo, InstructionPage, NewLotteryReminder, ValuationPage, BidPage, NewSignalReminder,
    OutcomePage
)
...
class PlayerBot(Bot):
    def play_round(self):
        ...
        if self.round_number != 1 and ((self.round_number-1) % (Constants.rounds_per_lottery + 1)) == 0:
